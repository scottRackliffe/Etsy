...
This document summarizes **Etsy rules and policies** that apply to the Etsy Sales Manager application and our design decisions. We follow these so the app and its users stay in good standing with Etsy.
...
| Rule | Our compliance |
|------|-----------------|
| **Original photos of actual product** | Etsy requires original photos of the item the buyer will receive, not stock or renderings (with limited exceptions). Our inventory “picture 1–10” and “condition pictures 1–5” are intended for the seller’s own photos of their items; we do not encourage or support stock imagery. |
...
| **Minimize stored data** | We store only what’s needed: tokens in cookies for the session; inventory/customers/purchases in our DB per user. We do not resell or share Etsy data. |
...
*Last aligned with Etsy policies: 2025-02-15. Verify current rules at the links above.*
