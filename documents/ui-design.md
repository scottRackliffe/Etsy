...
- **Tabs** — Use clear, everyday names (Dashboard, Sales, Inventory, Receipts, Customers, Reports, Config). Order follows how people work: overview first, then day-to-day work (sales, inventory, customers), then reports, then settings.
...
**Recommendation:** Start with **Dashboard**, **Sales**, **Inventory**, **Receipts**, **Customers**, **Reports**, **Tutorial and tips**, **Config**. Treat “Outstanding” as a **panel** on the right (or left) on every tab, not its own tab—unless you want a full-page “Outstanding” tab as well.
