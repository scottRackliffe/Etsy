...
| **WS-CR19** | [WS-CR19_remove-per-field-fix-buttons.md](WS-CR19_remove-per-field-fix-buttons.md) | Remove redundant per-field "Fix" buttons (keep cycle + per-row + global refine) — owner request | Tier 2 (UX) → Sonnet |
