...
| **WS-CR18** | [WS-CR18_photo-vision-empty-economy-model.md](WS-CR18_photo-vision-empty-economy-model.md) | Per-photo AI vision empty → provisional — **DIAGNOSED** (reasoning-budget disproven; low-rate non-retried 200); impl ready for Sonnet | Tier 2 → Sonnet |
