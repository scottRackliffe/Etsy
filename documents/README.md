...
This folder holds all project documentation.
...
| [knowledge-base-design.md](knowledge-base-design.md) | **Tutorial and tips (knowledge base)** — Design: search, index, links to files in the system folder. Tutorial and tips merged in one tab. |
...
| [adr/](adr/) | **Architecture Decision Records** — Design and scope decisions (database, inventory, customers, reports, base system, data storage). See [adr/README.md](adr/README.md) for the index. |
