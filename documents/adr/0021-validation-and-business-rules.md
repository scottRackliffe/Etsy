...
| description | Optional. If present, string (no max length specified; implementation may set a limit, e.g. 2000 chars). | — |
...
| email | Optional. If present, string; implementation may validate email format. | “Invalid email format.” |
...
| business_* | Optional strings. No format validation. | — |
