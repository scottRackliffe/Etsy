...
CREATE INDEX IF NOT EXISTS idx_inventory_item_number ON inventory(item_number);
CREATE INDEX IF NOT EXISTS idx_inventory_status ON inventory(status);
CREATE INDEX IF NOT EXISTS idx_purchases_inventory_id ON purchases(inventory_id);
CREATE INDEX IF NOT EXISTS idx_other_costs_inventory_id ON other_costs(inventory_id);
